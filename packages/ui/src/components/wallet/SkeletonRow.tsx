  ...
  return (
    <div className="flex items-center gap-2.5 border-b border-line px-3.5 py-3 last:border-b-0">
      ...
      <div className="flex flex-1 flex-col gap-1.5">
        ...
        <div className="h-[11px] w-[40%] animate-pulse rounded-md bg-line motion-reduce:animate-none motion-reduce:opacity-70" />
      </div>
      <div className="flex flex-shrink-0 flex-col items-end gap-1.5">
        <div className="h-[11px] w-12 animate-pulse rounded-md bg-line motion-reduce:animate-none motion-reduce:opacity-70" />
        <div className="h-[11px] w-12 animate-pulse rounded-md bg-line motion-reduce:animate-none motion-reduce:opacity-70" />
      </div>
    </div>
  );
