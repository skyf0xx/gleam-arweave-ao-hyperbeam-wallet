...
/**
 * The small dot + label network/connection-status indicator. Uses the
 * plain semantic `positive`/`warning`/`muted` tones, never a beam
 * color — status is not an identity moment.
 */
